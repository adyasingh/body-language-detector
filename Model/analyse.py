...
ap.set_defaults(report = False)
ap.set_defaults(save = False)
args = vars(ap.parse_args())

path = "/Users/adyasingh/Desktop/body-language-detector/Model/"
...
if args["report"]:
    bodyLanguageFile = "Data/BL_"+ args["video_file"] +".csv"
    attentionFile = "Data/A_"+ args["video_file"] +".csv"
